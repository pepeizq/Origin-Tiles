Module OriginBBDD
    ...
    Public Function BuscarenListado(idOrigin As String, devolver As Integer)
        ...
        Dim lista As New List(Of OriginBBDDEntrada) From {
            New OriginBBDDEntrada("A Way Out", New List(Of String) From {"Origin.OFR.50.0001900", "Origin.OFR.50.0002487", "Origin.OFR.50.0002488"}, "1222700"),
            New OriginBBDDEntrada("Apex Legends", New List(Of String) From {"Origin.OFR.50.0002694"}, "1172470"),
            New OriginBBDDEntrada("Anthem", New List(Of String) From {"Origin.OFR.50.0001521", "Origin.OFR.50.0002688", "Origin.OFR.50.0002755", "Origin.OFR.50.0002760", "Origin.OFR.50.0002980"}, Nothing),
            ...
            New OriginBBDDEntrada("Battlefield V", New List(Of String) From {"Origin.OFR.50.0002683", "Origin.OFR.50.0002859", "Origin.OFR.50.0002860", "Origin.OFR.50.0002861", "Origin.OFR.50.0002862", "Origin.OFR.50.0002863", "Origin.OFR.50.0002942", "Origin.OFR.50.0004340", "Origin.OFR.50.0004343", "Origin.OFR.50.0004346"}, "1238810"),
            ...
            New OriginBBDDEntrada("Burnout Paradise Remastered", New List(Of String) From {"Origin.OFR.50.0002535", "Origin.OFR.50.0002537", "Origin.OFR.50.0002541"}, "1238080"),
            ...
            New OriginBBDDEntrada("Command & Conquer Red Alert 3", New List(Of String) From {"OFB-EAST:52211", "DR:106608500"}, "17480"),
            New OriginBBDDEntrada("Command & Conquer Red Alert 3 Uprising", New List(Of String) From {"DR:111298000", "DR:110709700"}, "24800"),
            New OriginBBDDEntrada("Command & Conquer Remastered Collection", New List(Of String) From {"Origin.OFR.50.0003515", "Origin.OFR.50.0004022", "Origin.OFR.50.0004044"}, "1213210"),
            ...
            New OriginBBDDEntrada("FIFA 20", New List(Of String) From {"Origin.OFR.50.0003156", "Origin.OFR.50.0003453", "Origin.OFR.50.0003640"}, Nothing),
            New OriginBBDDEntrada("FIFA 21", New List(Of String) From {"Origin.OFR.50.0003912", "Origin.OFR.50.0003917", "Origin.OFR.50.0004184", "Origin.OFR.50.0004195", "Origin.OFR.50.0004215", "Origin.OFR.50.0004224", "Origin.OFR.50.0004225", "Origin.OFR.50.0004235", "Origin.OFR.50.0004237"}, "1313860"),
            New OriginBBDDEntrada("Jade Empire: Special Edition", New List(Of String) From {"OFB-EAST:1000017"}, "7110"),
            New OriginBBDDEntrada("It Takes Two", New List(Of String) From {"Origin.OFR.50.0004024", "Origin.OFR.50.0004288"}, "1426210"),
            New OriginBBDDEntrada("Madden NFL 20", New List(Of String) From {"Origin.OFR.50.0003091", "Origin.OFR.50.0003417"}, Nothing),
            New OriginBBDDEntrada("Madden NFL 21", New List(Of String) From {"Origin.OFR.50.0003744", "Origin.OFR.50.0004029", "Origin.OFR.50.0004122", "Origin.OFR.50.0004123", "Origin.OFR.50.0004124", "Origin.OFR.50.0004125", "Origin.OFR.50.0004415"}, "1239520"),
            ...
            New OriginBBDDEntrada("Mass Effect Legendary Edition", New List(Of String) From {"Origin.OFR.50.0004049", "Origin.OFR.50.0004264"}, "1328670"),
            ...
            New OriginBBDDEntrada("Need For Speed Heat", New List(Of String) From {"Origin.OFR.50.0003424", "Origin.OFR.50.0003426", "Origin.OFR.50.0003439", "Origin.OFR.50.0003440", "Origin.OFR.50.0003514"}, "1222680"),
            New OriginBBDDEntrada("Need For Speed Hot Pursuit", New List(Of String) From {"DR:210703600"}, Nothing),
            New OriginBBDDEntrada("Need For Speed Hot Pursuit Remastered", New List(Of String) From {"Origin.OFR.50.0004030", "Origin.OFR.50.0004092", "Origin.OFR.50.0004310"}, "1328660"),
            New OriginBBDDEntrada("Need For Speed Most Wanted", New List(Of String) From {"OFB-EAST:46851", "OFB-EAST:52699"}, "1262560"),
            New OriginBBDDEntrada("Need For Speed Payback", New List(Of String) From {"Origin.OFR.50.0001684", "Origin.OFR.50.0002149", "Origin.OFR.50.0002155", "Origin.OFR.50.0002167", "Origin.OFR.50.0002168", "Origin.OFR.50.0002170"}, "1262580"),
            ...
            New OriginBBDDEntrada("Plants vs. Zombies: Battle for Neighborville", New List(Of String) From {"Origin.OFR.50.0002623", "Origin.OFR.50.0003568", "Origin.OFR.50.0003634", "Origin.OFR.50.0003673", "Origin.OFR.50.0003675", "Origin.OFR.50.0004019", "Origin.OFR.50.0004020"}, "1262240"),
            ...
            New OriginBBDDEntrada("Rocket Arena", New List(Of String) From {"Origin.OFR.50.0003997", "Origin.OFR.50.0004026", "Origin.OFR.50.0004162", "Origin.OFR.50.0004169", "Origin.OFR.50.0004171"}, "1233550"),
            ...
            New OriginBBDDEntrada("Star Wars Battlefront II", New List(Of String) From {"Origin.OFR.50.0001523", "Origin.OFR.50.0002015", "Origin.OFR.50.0002148", "Origin.OFR.50.0002898"}, "1237950"),
            New OriginBBDDEntrada("Star Wars Jedi: Fallen Order", New List(Of String) From {"Origin.OFR.50.0003794", "Origin.OFR.50.0003795", "Origin.OFR.50.0003797", "Origin.OFR.50.0003798", "Origin.OFR.50.0003815", "Origin.OFR.50.0004032"}, "1172380"),
            New OriginBBDDEntrada("Star Wars Squadrons", New List(Of String) From {"Origin.OFR.50.0003112", "Origin.OFR.50.0003896", "Origin.OFR.50.0004097", "Origin.OFR.50.0004099", "Origin.OFR.50.0004214"}, "1222730"),
            ...
            New OriginBBDDEntrada("Unravel Two", New List(Of String) From {"Origin.OFR.50.0002403", "Origin.OFR.50.0002520", "Origin.OFR.50.0002522"}, "1225570"),

...
Public NotInheritable Class MainPage
    ...
    Private Sub Page_Loaded(sender As Object, e As RoutedEventArgs)
        ...
        AddHandler botonAñadirCarpetaOrigin.PointerEntered, AddressOf UsuarioEntraBoton
        AddHandler botonAñadirCarpetaOrigin.PointerExited, AddressOf UsuarioSaleBoton

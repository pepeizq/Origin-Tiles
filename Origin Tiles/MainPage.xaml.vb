...
Public NotInheritable Class MainPage
    ...
    Private Sub Nv_Loaded(sender As Object, e As RoutedEventArgs)
        ...
        nvPrincipal.MenuItems.Add(MasCosas.Generar("https://github.com/pepeizq/Origin-Tiles", "https://poeditor.com/join/project/ieHSx4J5lX", "https://www.youtube.com/watch?v=EMRq5ZNdApc"))
    ...
    Private Async Sub BotonAbrirYoutube_Click(sender As Object, e As RoutedEventArgs) Handles botonAbrirYoutube.Click
        ...
        Await Launcher.LaunchUriAsync(New Uri("https://www.youtube.com/watch?v=EMRq5ZNdApc"))
    ...
    Private Sub BotonCerrarTiles_Click(sender As Object, e As RoutedEventArgs) Handles botonCerrarTiles.Click
        ...
        If ApplicationData.Current.LocalSettings.Values("ancho_grid_tiles") > 0 Then
            If Origin.anchoColumna < ApplicationData.Current.LocalSettings.Values("ancho_grid_tiles") Then
                gvTiles.Width = ApplicationData.Current.LocalSettings.Values("ancho_grid_tiles")
                gvTiles.Padding = New Thickness(5, 0, 5, 0)
            End If
        End If
    ...
    Private Async Sub BotonComprarApp_Click(sender As Object, e As RoutedEventArgs) Handles botonComprarApp.Click
        ...
        If Not usuarios Is Nothing Then
            If usuarios.Count > 0 Then
                ...
                Await contexto.RequestPurchaseAsync("9P6TTBLTHP0L")
            End If
        End If
